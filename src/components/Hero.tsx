...
export default function Hero() {
  ...
  return (
    <div className="relative w-full h-screen overflow-hidden bg-text2 dark:bg-primary2">
      {/* Slides */}
      {slides.map((slide, index) => (
        ...
        >
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center text-white text-center px-6">
            ...
            <button className="bg-primary  px-4 py-2 rounded-lg mt-16 font-sans">Register Now</button>
          </div>
        </motion.div>
      ))}
