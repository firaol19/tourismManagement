...
export default function NavBar(){
   ...
   //     }
    ...
    return(
        <div className={`bg-secondary  z-50 text-main2 dark:text-main2 w-full h-16 flex items-center px-2 sm:px-10 lg:px-20 justify-between overflow-hidden ${pathname === "/admin" ||  pathname.startsWith("/Message2/") || pathname.startsWith("/list/") || pathname.startsWith("/register/")  || pathname === "/bookedService" || pathname === "/BookedPackages" || pathname === "/payments" || pathname === "/reviewAdmin" || pathname === "/canceledBookings" || pathname === "/message" || pathname.startsWith("/guide/") || pathname.startsWith("/acco_provider/") || pathname.startsWith("/tra_provider/") || pathname.startsWith("/destination_provider/") || pathname === "/c_service" ? "hidden" : "" }`} >
